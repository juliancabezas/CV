...
aboutme: "Data science, GIS, Remote Sensing, R Programming"
...
edu <- data.frame("Titulo"=c("Renewable Natural Resources Engineer","Bachelor of Sciences in Renewable Natural Resources"),
              "Cuando"=c("2010-2015","2010-2015"),
              "Ins"=c("University of Chile","University of Chile"),
              "Donde"=c("Santiago, Chile","Santiago, Chile"))
 ...
 * Advancd R programming skills.
 * Basic Python, SQL and Git skills.
 * Intermediate-advanced skills in GIS and remote sensing softwares: ArcGIS 10.4, ENVI 5.1  and QGIS.
 * Intermediate skills in SAS software (certified at the National Institute of Statistics of Chile).
...
tribble(
  ...
  "National Project Personnel for the Unit of Climate Change and Environmental Services, National Forestry Corporation (CONAF)", "Food and Agriculture Organization of the United Nations (FAO)", "Santiago, Chile", "2019 - Current", "Support for the Monitoring and Measurement System of the National Strategy of Climate Change and Vegetation Resources. REDD+ Technical Annex elaboration and reviewing process",
 ...
 *	MS. Daniel Montaner. MRV coordinator. National Forestry Corporation (CONAF). e-mail: daniel.montaner@conaf.cl
 *  MS. Denisse Lopez. R&D Subdirector. National Institute of Statistics (INE). e-mail: denisse.lopez@ine.cl
