...
tribble(
  ...
  "Analista Estadístico", "Instituto Nacional de Estadísticas (Departamento de Innovación y Desarrollo)", "Santiago, Chile", "2018 - 2019", list("Desarrollo de algoritmos de analisis estadistico"," Implementation de algoritmos de text mining para la clasificacion automatica de textos de la encuesta nacional del empleo"),
